...
//#region node_modules/.nitro/vite/services/ssr/assets/server-CkSHKjej.js
var server_CkSHKjej_exports = /* @__PURE__ */ __exportAll$1({
	a: () => deleteCookie$1,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-x-7uPW-_.mjs");
...
var manifest = {
	"02954ca19c2b9d0df9ff0b7f53b478a4dd8b57ac1b13131bb0b979fefbeb451d": {
		...
		importer: () => import("./xtream.functions-DAfT6TUA.mjs").then((n) => n.t)
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-ULJc8M43.mjs").then((n) => n.t),
...
//#endregion
export { getCookie as a, deleteCookie$1 as i, __exportAll as n, getServerFnById as o, createServerFn as r, server_CkSHKjej_exports as s, TSS_SERVER_FUNCTION as t };
