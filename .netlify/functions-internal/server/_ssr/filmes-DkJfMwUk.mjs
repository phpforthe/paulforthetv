...
import { g as getVodStreams, h as getVodCategories } from "./router-ULJc8M43.mjs";
...
import { n as PosterCard } from "./PosterCard-DjBd_oe5.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/filmes-DkJfMwUk.js
...
function MoviesPage() {
	...
	if (isLoading) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Splash, { message: "Carregando catálogo de filmes..." });
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TvShell, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("aside", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: (movies ?? []).slice(0, visible).map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PosterCard, {
					title: m.name,
					image: m.stream_icon,
			...
			}), (movies?.length ?? 0) > visible && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
