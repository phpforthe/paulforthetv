...
import { i as toResponse, n as deleteCookie, r as parseCookies, t as H3Event } from "../_libs/h3-v2+rou3+srvx.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/server-DBSzQuRl.js
var server_DBSzQuRl_exports = /* @__PURE__ */ __exportAll$1({
	a: () => deleteCookie$1,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-XYehE2ad.mjs");
...
var manifest = {
	"02954ca19c2b9d0df9ff0b7f53b478a4dd8b57ac1b13131bb0b979fefbeb451d": {
		functionName: "logoutFn_createServerFn_handler",
		importer: () => import("./xtream.functions-B7sSq8Tn.mjs").then((n) => n.t)
	},
	"0422d0ea8b8a00e4b332fb46c32678f778021c84c53c0d2426506cfdd120ddc6": {
		functionName: "getSeriesList_createServerFn_handler",
		importer: () => import("./xtream.functions-B7sSq8Tn.mjs").then((n) => n.t)
	},
	"4b2db185cc0399aadf510337c42dd067a9ed83609a36e3f0d2fa8ff70569b6e8": {
		functionName: "loginFn_createServerFn_handler",
		importer: () => import("./xtream.functions-B7sSq8Tn.mjs").then((n) => n.t)
	},
	"61fadd2fb7afd70d4d3e841225732442542f53eb84f39e48e6ff0a90454c4374": {
		functionName: "getLiveStreamUrl_createServerFn_handler",
		importer: () => import("./xtream.functions-B7sSq8Tn.mjs").then((n) => n.t)
	},
	"6dc52dbd9015eec729484c7bffb8887f52089ef2148e56059816d56300317ef6": {
		functionName: "getSeriesCategories_createServerFn_handler",
		importer: () => import("./xtream.functions-B7sSq8Tn.mjs").then((n) => n.t)
	},
	"71809cb64373e795ace7ea14d2b94a73011e0a944b54f32bf7911d7d7920be75": {
		functionName: "getAccountInfo_createServerFn_handler",
		importer: () => import("./xtream.functions-B7sSq8Tn.mjs").then((n) => n.t)
	},
	"71851484db01981753633808d647b39d6bd37a8b29dc690fa5765acda0b13103": {
		functionName: "getHome_createServerFn_handler",
		importer: () => import("./xtream.functions-B7sSq8Tn.mjs").then((n) => n.t)
	},
	"71d4a15dcfa6e955435ee81cda1188b764d41dcc9c5bbb09a3bf6e843e6231c3": {
		functionName: "getVodCategories_createServerFn_handler",
		importer: () => import("./xtream.functions-B7sSq8Tn.mjs").then((n) => n.t)
	},
	"79368ffdbf3baa8d0cbd8031f44d059def278fa4e4b62ba806ab4934deb3dfa7": {
		functionName: "getSeriesDetail_createServerFn_handler",
		importer: () => import("./xtream.functions-B7sSq8Tn.mjs").then((n) => n.t)
	},
	"83907d4c3ae72ba7097a70a5afde72115d57861ed97c8cb2769b3f0b5456a5b5": {
		functionName: "getLiveCategories_createServerFn_handler",
		importer: () => import("./xtream.functions-B7sSq8Tn.mjs").then((n) => n.t)
	},
	"914c8c60e2220477eed9cd6f711dbaaede2fd8009c3671eabc82f20577073a45": {
		functionName: "getSession_createServerFn_handler",
		importer: () => import("./xtream.functions-B7sSq8Tn.mjs").then((n) => n.t)
	},
	"b88ea5fd08ebde001d443e52220378d563bf653e5d8ac75cd768dad8d0a50844": {
		functionName: "getNowPlaying_createServerFn_handler",
		importer: () => import("./xtream.functions-B7sSq8Tn.mjs").then((n) => n.t)
	},
	"bdcc99ba303c1632be24fccf23159f858e00d3103591d3194310055af67655fa": {
		functionName: "getVodStreams_createServerFn_handler",
		importer: () => import("./xtream.functions-B7sSq8Tn.mjs").then((n) => n.t)
	},
	"d2767f090172f499df265cdd5c235e7cb7ac2cc5618948b76c87c7fadc241ceb": {
		functionName: "getMovieDetail_createServerFn_handler",
		importer: () => import("./xtream.functions-B7sSq8Tn.mjs").then((n) => n.t)
	},
	"df8423e255ad2454a21c41710e7e55ec4ed1ba1b5454c69f48797228ac9d257e": {
		functionName: "getLiveStreams_createServerFn_handler",
		importer: () => import("./xtream.functions-B7sSq8Tn.mjs").then((n) => n.t)
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D8XdcCcT.mjs").then((n) => n.t),
...
//#endregion
export { getCookie as a, deleteCookie$1 as i, __exportAll as n, getServerFnById as o, createServerFn as r, server_DBSzQuRl_exports as s, TSS_SERVER_FUNCTION as t };
